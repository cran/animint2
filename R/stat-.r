...
Stat <- gganimintproto("Stat",
  ...
  parameters = function(self, extra = FALSE) {
    ...
    panel_args <- names(gganimintproto_formals(self$compute_panel))
    group_args <- names(gganimintproto_formals(self$compute_group))
    args <- if ("..." %in% panel_args) group_args else panel_args

    # Remove arguments of defaults
    args <- setdiff(args, names(gganimintproto_formals(Stat$compute_group)))
